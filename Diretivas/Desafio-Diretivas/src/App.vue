	...
	directives: {
		quando: {
			bind(el, binding) {
				...
				el.addEventListener(tipo, fn) // Passar essa função quando o evento de um tipo específico
			}
		}
	},
	methods: {
		...
		mouseEnter() {
			console.log('Ação executada no Mouse Enter!');
		},
		mouseLeave() {
			console.log('Ação executada no Mouse Leave!');
		}
	}
}
</script>
